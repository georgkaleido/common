...
echo "--extra-index-url https://\${FURY_AUTH_TOKEN}:@deps.kaleido.ai/pypi/" >> requirements.txt
...
echo "--extra-index-url https://\${FURY_AUTH_TOKEN}:@deps.kaleido.ai/pypi/" >> requirements-dev.txt
