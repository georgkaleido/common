...
def main():
    ...
    for qi_bucket_name in dir_list:
        ...
        normalized_best_checkpoint_blob_path = os.path.join(
            qi_bucket_path, "trimap513-deeplab-res2net.pth.tar"
        )
        ...
        bucket.upload(
            local_path=normalized_best_checkpoint_local_path, blob_path=normalized_best_checkpoint_blob_path
        )
