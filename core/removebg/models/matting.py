...
from kaleido.models.fba.models import fba_decoder, MattingModule
...
class Matting(nn.Module):
    ...
    def __init__(self, fba_fusion=True, pretrained=False):
        ...
        net_decoder = fba_decoder(conv=conv, norm=norm, alpha_sigmoid=False, color_sigmoid=False, fba_fusion=fba_fusion)
