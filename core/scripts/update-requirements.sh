...
pip-compile -U requirements-deploy.in -o requirements-deploy.txt --find-links https://download.pytorch.org/whl/torch_stable.html --extra-index-url ${extra_index_url} --no-emit-index-url --no-header --find-links https://download.pytorch.org/whl/torch_stable.html
