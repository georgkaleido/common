...
def main():
    ...
    # Quick fix, save all the checkpoints with best-vN.ckpt, up to 20
    checkpoint_names = [f"best-v{n}.ckpt" for n in range(1, 21)]
    checkpoint_names.insert(0, "best.ckpt")
    checkpoint_names.insert(0, "last.ckpt")
    configure_cloud_training(
