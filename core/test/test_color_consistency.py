...
def test_cmyk_icc_bg(req_fn):
    ...
    (
        ...
        _,
        _,
    ) = req_fn("data/CMYK_icc.jpg", {"format": "png", "size": "full", "channels": "alpha"})
    im, im_in, headers, status_code = req_fn(
        "data/CMYK_icc.jpg", {"format": "zip", "size": "full", "bg_color": "ffffffff"}
    )
    im_color = im[0]
...
def test_cmyk_icc_bg_im(req_fn):
    ...
    im, im_in, headers, status_code = req_fn(
        "data/CMYK_icc.jpg", {"format": "zip", "size": "full", "bg_image_file": bg_image_file}
    )
    im_color = im[0]
...
def test_rgb(req_fn):
    ...
    im, im_in, headers, status_code = req_fn(
        "data/RGB.png", {"format": "zip", "size": "full", "semitransparency": "false", "shadow": "false"}
    )
    im_color, im_alpha = im
...
def test_rgb_png(req_fn):
    ...
    im, im_in, headers, status_code = req_fn(
        "data/RGB.png", {"format": "png", "size": "full", "semitransparency": "false", "shadow": "false"}
    )
...
def test_rgb_icc(req_fn):
    ...
    im, im_in, headers, status_code = req_fn(
        "data/RGB_icc.png", {"format": "zip", "size": "full", "semitransparency": "false", "shadow": "false"}
    )
    im_color, im_alpha = im
...
def test_rgb_icc_png(req_fn):
    ...
    im, im_in, headers, status_code = req_fn(
        "data/RGB_icc.png", {"format": "png", "size": "full", "semitransparency": "false", "shadow": "false"}
    )
...
def test_rgb_icc_bg(req_fn):
    ...
    (
        ...
        _,
        _,
    ) = req_fn("data/RGB_icc.png", {"format": "png", "size": "full", "channels": "alpha"})
    im, im_in, headers, status_code = req_fn(
        "data/RGB_icc.png",
        {
            "format": "zip",
...
def test_l_icc_bg(req_fn):
    ...
    (
        ...
        _,
        _,
    ) = req_fn("data/L_icc.jpg", {"format": "png", "size": "full", "channels": "alpha"})
    im, im_in, headers, status_code = req_fn(
        "data/L_icc.jpg", {"format": "zip", "size": "full", "bg_color": "ffffffff"}
    )
    im_color = im[0]
...
def test_l_icc_bg_im(req_fn):
    ...
    im, im_in, headers, status_code = req_fn(
        "data/L_icc.jpg", {"format": "zip", "size": "full", "bg_image_file": bg_image_file}
    )
    im_color = im[0]
